...
namespace CaloriasC
{
	void Funciones::menu_calculadora(string &ejercicios) {
		system("cls");
	...
	void Funciones::datos_usuario(string &genero, int &edad, int &altura, int &peso, int &tiempo_actividad, int &TMB) {
		system("cls");
	...
	void Funciones::running(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 740;
		}
	...
	void Funciones::caminar(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 270;
		}
	...
	void Funciones::nadar(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 360;
		}
	...
	void Funciones::gym(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 180;
		}
	...
	void Funciones::bici(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 720;
		}
	...
	void Funciones::yoga(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 240;
		}
	...
	void Funciones::boxeo(int& peso, int& calories_base, int& calories_perdudes, int& tiempo_actividad, int& TMB) {
		if (peso <= 70)
		{
			calories_base = 540;
		}
